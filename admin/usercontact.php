...
<body>
  <h1 class="text-center text-success ">USER CONTACT</h1>
                      ...
                      <table class="table text-white my-2">
                        <thead >
                          <tr class="bg-white">
                            ...
                            <th class="text-center text-danger">  User Email </th>
                            <th class="text-center text-danger">  Subject </th>
                            <th class="text-center text-danger"> Message </th>
                        ...
                        <?php
                         ...
                         $row = mysqli_query($connect,"SELECT * FROM usercontact");
                         while($data = mysqli_fetch_array($row))
                         {
                             ...
                             <td class="border fw-bold fs-3 text-uppercase">'.$data[4].'</td>
