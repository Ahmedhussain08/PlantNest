...
?>
    ...
    <section style="margin-top:100px !important;" class="mt-5" style="background-color: #eee;">
  <div class="container py-3">
    <div class="row mt-5">
    <?php
     if(isset($_GET['catdetail'])) {
         $catid = $_GET['catdetail'];
         $product = mysqli_query($connect, "SELECT * FROM plants WHERE Category_Id = '$catid'");
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between">
              ...
              $categoryName = $catname['Category_Name'];
              ?>
              <p class="small"><a href="#!" class="text-muted"><?php echo $categoryName; ?></a></p>
            </div>
